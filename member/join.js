...
let button_confirm = document.querySelector(
    ".terms_button>input:nth-of-type(1)"
);
...
// 가입 정보 작성 여부 확인
let join_button = document.querySelector(
