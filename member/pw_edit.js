...
function pw1_check() {
    let chkLower = document.querySelector(
        ".member_pedit_p2>span:nth-of-type(1)"
    );
    let chkUpper = document.querySelector(
        ".member_pedit_p2>span:nth-of-type(2)"
    );
    let chkNumber = document.querySelector(
        ".member_pedit_p2>span:nth-of-type(3)"
    );
    let chkCharacter = document.querySelector(
        ".member_pedit_p2>span:nth-of-type(4)"
    );
    let chkLength = document.querySelector(
        ".member_pedit_p2>span:nth-of-type(5)"
    );
